<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Lista fornitori</h5>
            </div>
            <div class="col-8 col-sm-auto ms-auto text-end ps-0">
                <div id="orders-actions"><button class="btn btn-falcon-default btn-sm fa_nuovofornitore" type="button"><svg class="svg-inline--fa fa-plus fa-w-14" data-fa-transform="shrink-3 down-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="" style="transform-origin: 0.4375em 0.625em;">
                    ...
                    <button class="btn btn-falcon-default btn-sm fo_esporta" type="button" disabled><svg class="svg-inline--fa fa-external-link-alt fa-w-16" data-fa-transform="shrink-3 down-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="external-link-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style="transform-origin: 0.5em 0.625em;">
    ...
    <div class="card-body p-3">
        <div id="FornitoriTable" data-list='{"valueNames":["fornitore", "avere", "dare", "scadere", "scaduto"],"page":10,"pagination":true}'>
            <div class="row">
                <div class="col-sm-12 col-md-3">
                    <div class="row mb-3"><label class="col-3 col-form-label-sm" for="fo_search">Ricerca:</label>
                        <div class="col-9"><input class="form-control form-control-sm auto" id="fo_search" type="search" placeholder=" " onchange="AggiornaLista_fo()" autocomplete="off"></div>
                    </div>
                </div>
            </div>
            <div class="table-responsive scrollbar">
                <table class="table table-bordered fs--1 mb-0">
                    <thead class="bg-200 text-900">
                        <tr>
                            <th></th>
                            <th class="sort" data-sort="fornitore">Ragione Sociale</th>
                    ...
                    <tbody class="list" id="FornitoriTableBody"></tbody>
                    <tfoot class="bg-200 text-900" id="FornitoriTableFooter"></tfoot>
                </table>
            </div>
